...
def get_sources(category):
    ...
    '''
    get_sources_url = 'https://newsapi.org/v2/sources?language=en&category={}&apikey=89142e7040674f80ba81a047b0572c94'.format(category, api_key)
...
def get_articles(id):
    ...
    '''
    get_all_articles_url = 'https://newsapi.org/v2/everything?sources={}&apiKey=ad71d434e3a64203b8ad6b3317fcd372'.format(id, api_key)
...
def search_articles(query):
    ...
    '''
    search_articles_url = 'https://newsapi.org/v2/everything?q={}&apiKey=ad71d434e3a64203b8ad6b3317fcd372'.format(query, api_key)
